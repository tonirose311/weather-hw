function createCityList(citySearchList) {
  ...
  function populateCityWeather(city, citySearchList) {
    ...
    var queryURL =
      "https://api.openweathermap.org/data/2.5/weather?&units=imperial&appid=47971c1c28872f0481f6a4f2123665c6&q=" +
      city;
    //   https://api.openweathermap.org/data/2.5/onecall/timemachine?lat={lat}&lon={lon}&dt={time}&appid={885e9149105e8901c9809ac018ce8658&q=}
    var queryURL2 =
      "https://api.openweathermap.org/data/2.5/forecast?&units=imperial&appid=47971c1c28872f0481f6a4f2123665c6&q=" +
      city;
    ...
    $.ajax({
      ...
      .then(function(weather) {
        ...
        var queryURL3 =
          "https://api.openweathermap.org/data/2.5/uvi/forecast?&units=imperial&appid=47971c1c28872f0481f6a4f2123665c6&q=" +
          "&lat=" +
          latitude +
          "&lon=" +
          longitude;
